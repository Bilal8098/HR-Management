...
private void loadSalaryData() {
    try {
        Connection conn = DatabaseConnection.getConnection(); // Your DB helper class
        ...
        ObservableList<EmployeeSalary> list = javafx.collections.FXCollections.observableArrayList();
        while (rs.next()) {
